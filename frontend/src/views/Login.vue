			...
			<v-card class="ios-login-card position-relative" elevation="0">
				...
				<div class="login-form">
					<div class="input-group mb-4">
						...
						<input v-model="email" type="email" placeholder="exemplo@email.com" class="ios-input-modern" @keyup.enter="login" />
					</div>
...
<style scoped>
	...
	.ios-input-modern {
		width: 100%;
		box-sizing: border-box;
		background: rgba(255, 255, 255, 0.05); /* Lighter glass for inputs */
